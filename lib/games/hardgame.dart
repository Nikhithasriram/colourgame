...
class _HardgamePageState extends State<HardgamePage>
  ...
  int len3 = Random().nextInt(9);
  int len4 = Random().nextInt(9);
  late Color qncolor;
  ...
  void initState() {
    ...
    opt1 = customcolor[len];
    opt2 = customcolor[len2];
      ...
      if (isopen == false) {
        if (counter <= 0) {
          ...
          if (correct > 0 && wrong > 0)
            ...
            Navigator.of(context).pushReplacementNamed(MyRoutes.result,
                arguments: {'c': 0, 'w': 0, 'back': MyRoutes.hardgameroute});
        } else {
          counter = counter - 1;
          if (counter < 10) {
  ...
  void mystate() {
    ...
    if (option == true) {
      qn = ans1;
      int index2 = name.indexOf(ans2);
      int index1 = name.indexOf(ans1);
      qncolor = customcolor[index2];
      int borderidex = Random().nextInt(6);
      border = bordercolor[borderidex];
      opt1 = customcolor[index1];
      opt2 = customcolor[index2];
    } else {
      qn = ans2;
  ...
  void correctwrong1() {
    int indexqncol = customcolor.indexOf(qncolor);
    int indexans = name.indexOf(ans1);
    int indexqn = name.indexOf(qn);
    int idexanscol = customcolor.indexOf(opt1);
    if (indexqncol == indexans && indexqn == idexanscol) {
      correct++;
  ...
  void correctwrong3() {
    int indexqncol = customcolor.indexOf(qncolor);
    int indexans = name.indexOf(ans2);
    int indexqn = name.indexOf(qn);
    int indexanscol = customcolor.indexOf(opt1);
    if (indexqncol == indexans && indexqn == indexanscol) {
      correct++;
      defaultanimationcolour = animatedcolourcorrect;
      defaulticon = corrrecticon;
      Future.delayed(Duration(milliseconds: 100), () {
  ...
  void correctwrong4() {
    ...
    int indexans = name.indexOf(ans1);
    int indexqn = name.indexOf(qn);
    int indexanscol = customcolor.indexOf(opt2);
    if (indexqncol == indexans && indexqn == indexanscol) {
      correct++;
      defaultanimationcolour = animatedcolourcorrect;
      defaulticon = corrrecticon;
