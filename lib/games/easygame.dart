...
class EasygamePage extends StatefulWidget {
  ...
  @override
  _EasygamePageState createState() => _EasygamePageState();
}
      ...
      if (isopen == false) {
        if (counter <= 0) {
          ...
          if (correct > 0 && wrong > 0)
            ...
            Navigator.of(context).pushReplacementNamed(MyRoutes.result,
                arguments: {'c': 0, 'w': 0, 'back': MyRoutes.easygameroute});
        } else {
          counter = counter - 1;
          if (counter < 10) {
