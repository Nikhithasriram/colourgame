...
class VeryEasygamePage extends StatefulWidget {
  const VeryEasygamePage({Key? key}) : super(key: key);

  @override
  _VeryEasygamePageState createState() => _VeryEasygamePageState();
}

class _VeryEasygamePageState extends State<VeryEasygamePage>
                ...
                child: Center(
                  child: Column(
                    children: [
                      ...
                      //       'assets/animation/tick_animation.riv'),
                      // )
                    ],
                  ),
                ),
          ...
          if (correct > 0 && wrong > 0)
            Navigator.of(context).pushReplacementNamed(MyRoutes.result,
                arguments: {
                  'c': correct,
                  'w': wrong,
                  'back': MyRoutes.veryEasygameroute
                });

          // Navigator.pushNamed(context, MyRoutes.result, arguments: {correct , wrong});
